...
public class Exp {
    ...
    public static void test() throws Exception {
     ...
     //  Origin_graph origin_graph = new Origin_graph(36692, 20, Config.EMAIL_ORIGIN_MATRIX_FILE_PATH, Config.EMAIL_ORIGIN_LABEL_FILE_PATH);
      Origin_graph origin_graph = new Origin_graph(4039, 20, Config.FACEBOOK_ORIGIN_MATRIX_FILE_PATH, Config.FACEBOOK_ORIGIN_LABEL_FILE_PATH);
     ...
     //  query_graph.printseq();
      ...
      origin_graph.add_some_edges(3);
      origin_graph.delete_some_edegs(3);
